 ...
 */
public class ArticleFragment extends BaseStatisticsFragment {
    ...
    public static ArticleFragment newInstance(int type, int productId, boolean isSummary) {
    ...
    public void initView(View view) {
        ...
        int projecttype = Constant.PROJECT_TYPE_ARTICLE;
